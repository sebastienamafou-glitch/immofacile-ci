...
const ACTION_LABELS: Record<AuditAction, string> = {
  ...
  BOOKING_PAYMENT_SUCCESS:  "Réservation payée",
  CROWDFUNDING_SUCCESS:     "Crowdfunding abouti",
...
const ACTION_COLOR: Record<AuditAction, string> = {
  PAYMENT_SUCCESS:          "text-emerald-400 bg-emerald-400/10 border-emerald-400/20",
  BOOKING_PAYMENT_SUCCESS:  "text-teal-400   bg-teal-400/10   border-teal-400/20",
  CROWDFUNDING_SUCCESS:     "text-cyan-400   bg-cyan-400/10   border-cyan-400/20",
  PAYMENT_FAILED:           "text-amber-400  bg-amber-400/10  border-amber-400/20",
  FRAUD_ATTEMPT:            "text-red-400    bg-red-400/10    border-red-400/20",
  KYC_VALIDATED:            "text-blue-400   bg-blue-400/10   border-blue-400/20",
  USER_DELETED:             "text-rose-500   bg-rose-500/10   border-rose-500/20",
};
